...
?>
<form class="custom" action="library/" method="get" name="fm_dir_search" id="fm_dir_searchb" accept-charset="UTF-8">
<div class="errorBox">one required</div>
  
<!--<div class="txtwhiteX txt15 padd10 padd0_b bold txtupper">Search Resources</div>-->
<div class="subcolumns">
	
	<div class="col-md-9 padd2">
	<div class="padd5_t padd0_l">	
	<div>
	<input type="text" id="dir_keywords" name="keyword" maxlength="50" class="form-control dir-groupX requiredX" placeholder="Search resources" value="<?php //echo @$dir_keywords; ?>" />
	</div>
	</div>
	</div>
	...
	<div class="col-md-3 padd2">
	  <div class="padd5_t">
		...
		<div>
			<div class="nomargin">
				<button type="input" name="dir_apply" id="dir_apply" value="Search" class="btn btn-success col-md-12 txt12">Go</button>
