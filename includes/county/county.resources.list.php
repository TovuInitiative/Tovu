...
if(count($section_pages))
{
	...
	foreach ($contPages as $contKey => $contVal) 						
	{
		...
		$item_brief	     = string_truncate($item_brief, 80, ' ', '...'); 
		...
		$fcontent .=  '<li><div class="block" style=""><div style="float:left;'.$icon_box.'">'.$upload_icon_disp.'</div>
...
{ 
	...
	echo '<div><ul id="" class="column column_half cont_dloads">';
	echo $fcontent;
	echo '</ul></div>';
