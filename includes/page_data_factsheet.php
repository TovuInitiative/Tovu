	...
	<div class="col-md-12 bg-white panel-home-guts">
        ...
        ?>
			<div id="wrapper" class="">
			    <div class="row">
			        <div class="col-md-7"><?php echo display_PageTitle('County Factsheet: <span class="txtmaroon">'.$datacounty.'</span> ', '', ''); ?></div>
			    ...
			    <iframe src="<?php echo DOMAIN_OPENCOUNTY; ?>factsheet.php?cid=<?php echo $datacounty_id; ?>" style="width:100%; height:2700px;" scrolling="yes"></iframe>
...
jQuery(document).ready(function($) {	
	$("#datacounty").change(function() {		 
		...
		location.href = "factsheets/?cid="+cid+"&tk="+Math.random();		
    });
});
</script>
