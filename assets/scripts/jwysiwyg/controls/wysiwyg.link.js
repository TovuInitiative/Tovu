	...
	*/
	$.wysiwyg.controls.link = {
		init: function (Wysiwyg) {
			...
			//Do new link element
			var b_selection = Wysiwyg.getRangeText(); 
			var b_img = Wysiwyg.dom.getElement("img"); /* && b_img == null*/ /*alert(b_selection.length);*/
			if (b_selection == null || b_selection == '') { window.alert("Select the text you wish to link"); return false; }
			
			formLinkHtml = '<div class="modal-dialog"><div class="modal-content"><div class="modal-header"><h4 class="modal-title">Insert Link</h4></div><div class="modal-body"><form class="wysiwyg"><fieldset><legend>{legend}</legend>' +
				'<div class="form-row"><label>{url}: <input type="text" name="linkhref" value=""/></label></div>' +
				'<div class="form-row"><label>{title}: <input type="text" name="linktitle" value=""/></label></div>' +
				'<div class="form-row"><label>{target}: <input type="text" name="linktarget" value=""/></label></div>' +
				'<div class="form-row"><input type="submit" class="button" value="{submit}"/> </div>' +
				'<div class="form-row"><input type="reset" value="{reset}"/></div></fieldset></form></div></div></div>';
