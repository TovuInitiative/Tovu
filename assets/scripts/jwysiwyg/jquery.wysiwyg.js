		...
		this.ui.initFrame = function () {
          ...
          if ($.wysiwyg.rmFormat) {
			...
			if (self.options.autoGrow) {
				...
				$(self.editorDoc.body).css("border", "1px solid white").css("font", "13px Helvetica, sans-serif").css("color", "#515962"); // cancel margin collapsing 
	...
	$(function () { // need access to jQuery UI stuff.
		...
		$.wysiwyg.dialog.register("default", function () {
			...
			this.init = function() {
				...
				var $link = $('<a  class="wysiwyg-dialog-close-button">X</a>');
